...
![Chuck tail red pipe slice past end of file](https://github.com/cursorless-dev/cursorless/raw/HEAD/images/chuckTailRedPipeSlicePastEndOfFile.gif)
...
See [CHANGELOG.md](https://github.com/cursorless-dev/cursorless/blob/HEAD/CHANGELOG.md).

## Attributions

See [NOTICE.md](https://github.com/cursorless-dev/cursorless/blob/HEAD/NOTICE.md).
