...
3. Add a reference to `onLanguage:yourlang` to the [activationEvents section of package.json](https://github.com/pokey/vscode-parse-tree/blob/HEAD/package.json). `yourlang` must be a [VSCode language identifier](https://code.visualstudio.com/docs/languages/identifiers).
4. Add your language to the top of the [Makefile](https://github.com/pokey/vscode-parse-tree/blob/HEAD/Makefile)
...
1. Update the variable `TREE_SITTER_VERSION` in the [`Makefile`](https://github.com/pokey/vscode-parse-tree/blob/HEAD/Makefile#L8);
2. Update the path to `web-tree-sitter` in [`package.json`](https://github.com/pokey/vscode-parse-tree/blob/HEAD/package.json#103);
3. (Optional) Create a new patch in `patches/tree-sitter+$TREE_SITTER_VERSION.patch`.

The script which builds our custom version is in the [`Makefile`](https://github.com/pokey/vscode-parse-tree/blob/HEAD/Makefile#L37-63).

## Change Log

See [CHANGELOG.md](https://github.com/pokey/vscode-parse-tree/blob/HEAD/CHANGELOG.md).
