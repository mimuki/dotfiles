...
" Baseline
hi Normal 
      \ term=NONE cterm=NONE ctermfg=black ctermbg=231
      \ gui=NONE guifg=#000000 guibg=#ffffff

" Faded
hi ColorColumn 
      \ term=NONE cterm=NONE ctermfg=NONE ctermbg=253 
      \ gui=NONE guifg=NONE guibg=#dadada
hi Comment
      \ term=NONE cterm=NONE ctermfg=136 ctermbg=NONE 
      \ gui=NONE guifg=#af8700 guibg=NONE
hi FoldColumn 
      \ term=NONE cterm=NONE ctermfg=136 ctermbg=NONE 
      \ gui=NONE guifg=#af8700 guibg=NONE
hi Folded
...
hi LineNr
      \ term=NONE cterm=NONE ctermfg=136 ctermbg=bg 
      \ gui=NONE guifg=#af8700 guibg=NONE
hi NonText
      \ term=NONE cterm=NONE ctermfg=136 ctermbg=NONE 
      \ gui=NONE guifg=#af8700 guibg=NONE
hi SignColumn
      \ term=NONE cterm=NONE ctermfg=240 ctermbg=bg 
      \ gui=NONE guifg=#585858 guibg=bg
hi SpecialComment 
      \ term=NONE cterm=NONE ctermfg=136 ctermbg=NONE 
      \ gui=NONE guifg=#af8700 guibg=NONE
hi SpecialKey
      ...
      \ gui=NONE guifg=#585858 guibg=bg
hi StatusLineNC 
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=195 
      \ gui=NONE guifg=fg guibg=#d7ffff
hi VertSplit 
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=195 
      \ gui=NONE guifg=fg guibg=#d7ffff
...
" Highlight
hi CursorColumn 
      \ term=NONE cterm=bold ctermfg=NONE ctermbg=NONE
      \ gui=NONE guifg=NONE guibg=NONE
hi CursorIM
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=4 
      \ gui=NONE guifg=fg guibg=#00ffff
hi CursorLineNr 
      \ term=NONE cterm=bold ctermfg=0 ctermbg=228 
      \ gui=NONE guifg=NONE guibg=#ffff87
hi CursorLine 
      \ term=NONE cterm=bold ctermfg=NONE ctermbg=NONE 
      \ gui=NONE guifg=NONE guibg=NONE
hi Cursor
      ...
      \ gui=NONE guifg=fg guibg=#00ffff
hi Directory
      \ term=NONE cterm=NONE ctermfg=53 ctermbg=NONE 
      \ gui=NONE guifg=#5f005f guibg=NONE
hi ErrorMsg
      \ term=NONE cterm=NONE ctermfg=9 ctermbg=white 
      \ gui=NONE guifg=#ff5555 guibg=white
hi Error
      \ term=NONE cterm=NONE ctermfg=9 ctermbg=white 
      \ gui=NONE guifg=#ff5555 guibg=white
hi IncSearch 
      \ term=NONE cterm=NONE ctermfg=white ctermbg=2 
      \ gui=NONE guifg=white guibg=#008000
hi Search 
      \ term=NONE cterm=NONE ctermfg=white ctermbg=2 
      \ gui=NONE guifg=white guibg=#008000
hi MatchParen
      \ term=NONE cterm=NONE ctermfg=15 ctermbg=4 
      \ gui=NONE guifg=#ffffff guibg=#000080
hi ModeMsg 
      \ term=NONE cterm=NONE ctermfg=53 ctermbg=NONE 
      \ gui=NONE guifg=#5f005f guibg=NONE
hi MoreMsg 
      ...
      \ gui=NONE guifg=#5f005f guibg=NONE
hi PmenuSel
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=13 
      \ gui=NONE guifg=fg guibg=#ff00ff
hi Question 
      \ term=NONE cterm=NONE ctermfg=53 ctermbg=NONE 
      \ gui=NONE guifg=#5f005f guibg=NONE
hi StatusLine 
      \ term=NONE cterm=NONE ctermbg=183 ctermfg=fg 
      \ gui=NONE guifg=white guibg=#000000
hi Todo 
      \ term=NONE cterm=NONE ctermfg=2 ctermbg=NONE 
      \ gui=NONE guifg=#008000 guibg=NONE
hi WarningMsg  
      \ term=NONE cterm=NONE ctermfg=9 ctermbg=white 
      \ gui=NONE guifg=#ff5555 guibg=white
hi WildMenu 
      \ term=NONE cterm=NONE ctermbg=fg ctermfg=183 
      \ gui=NONE guifg=#000000 guibg=white
hi Visual 
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=222
      \ gui=NONE guifg=NONE guibg=#ffd787
hi VisualNOS
      \ term=underline cterm=underline ctermfg=fg ctermbg=222 
      \ gui=underline guifg=NONE guibg=#ffd787

" Reversed
hi PmenuSbar 
      \ term=reverse cterm=reverse ctermfg=NONE ctermbg=NONE 
...
hi DiffAdd 
      ...
      \ gui=NONE guifg=#008000 guibg=NONE
hi DiffChange 
      \ term=NONE cterm=NONE ctermfg=94 ctermbg=NONE 
      \ gui=NONE guifg=#875f00 guibg=NONE
hi DiffDelete 
      \ term=NONE cterm=NONE ctermfg=1 ctermbg=NONE 
      \ gui=NONE guifg=#800000 guibg=NONE
hi DiffText 
      \ term=NONE cterm=NONE ctermfg=4 ctermbg=NONE 
      \ gui=NONE guifg=#000080 guibg=NONE

" Spell
hi SpellBad 
      \ term=underline cterm=underline ctermfg=5 ctermbg=NONE 
      \ gui=underline guifg=#cd00cd guibg=NONE
hi SpellCap 
      \ term=underline cterm=underline ctermfg=5 ctermbg=NONE 
      \ gui=underline guifg=#cd00cd guibg=NONE
hi SpellLocal 
...
hi Scrollbar 
      ...
      \ gui=NONE guifg=NONE guibg=NONE
hi TabLineFill 
      \ term=NONE cterm=NONE ctermfg=fg ctermbg=136 
      \ gui=NONE guifg=fg guibg=#af8700
hi TabLine 
      \ term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE 
      \ gui=NONE guifg=NONE guibg=NONE
hi Tooltip 
...
" Sneak
hi SneakLabelMask 
      \ term=NONE cterm=NONE ctermfg=black ctermbg=195 
      \ gui=NONE guifg=black guibg=#d7ffff
hi SneakTarget 
      \ term=NONE cterm=NONE ctermfg=black ctermbg=195 
      \ gui=NONE guifg=black guibg=#d7ffff
hi SneakLabelTarget 
      \ term=NONE cterm=NONE ctermfg=black ctermbg=183 
      \ gui=NONE guifg=black guibg=#d7afff
hi SneakScope 
      \ term=NONE cterm=NONE ctermfg=black ctermbg=183 
      \ gui=NONE guifg=black guibg=#d7afff
