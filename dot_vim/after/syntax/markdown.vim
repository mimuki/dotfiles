...
highlight h1Sym ctermfg=7 ctermbg=10 cterm=bold 
highlight h1Tex ctermfg=7 ctermbg=10 cterm=bold

syntax match h2Sym /^##\s\?/ nextgroup=h2Tex conceal
syntax match h2Tex /.\+/ contained
highlight h2Sym ctermfg=1 cterm=bold 
highlight h2Tex ctermfg=1 cterm=bold

syntax match h3Sym /^###\s\?/ nextgroup=h3Tex conceal
syntax match h3Tex /.\+/ contained
highlight h3Sym ctermfg=1 cterm=bold 
highlight h3Tex ctermfg=1 cterm=bold

syntax match h4Sym /^####\s\?/ nextgroup=h4Tex conceal
syntax match h4Tex /.\+/ contained
highlight h4Sym ctermfg=1 cterm=bold 
highlight h4Tex ctermfg=1 cterm=bold

syntax match h5Sym /^#####\s\?/ nextgroup=h5Tex conceal
syntax match h5Tex /.\+/ contained
highlight h5Sym ctermfg=4 cterm=bold 
highlight h5Tex ctermfg=4 cterm=bold

syntax match h6Sym /^######\s\?/ nextgroup=h6Tex conceal
syntax match h6Tex /.\+/ contained
highlight h6Sym ctermfg=4 cterm=bold 
highlight h6Tex ctermfg=4 cterm=bold
